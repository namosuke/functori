...
export default function App() {
  const initialContents = [
    {
      type: 'Message',
      children: "PHP関数しりとりへようこそ！<br>PHP関数しりとりは、あなたとCPUで交互にPHPの関数名を言い合うゲームです。<br>あなたは1つ前の関数の最後のアルファベットから始まる関数名を思い出し、入力してください。<br>降参したり、\"md5\"のように数字で終わる関数名を言ったほうが負けになります。<br>終了すると記録をSNSで共有できます。<br>どれだけ続けられるか挑戦してみてください！"
    },
    {
      type: 'Serif',
      userName: 'CPU',
